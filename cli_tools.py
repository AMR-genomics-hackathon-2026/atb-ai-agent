"""
Command-Line Interface (CLI) tools and convenience functions for working with the Claude Agent SDK in the terminal.

From: https://github.com/kenneth-liao/claude-agent-sdk-intro
"""
...
parser.add_argument("--output-style", "-os", default="Biocurator Assistant", help="Output style to use")
...
def print_rich_message(
    ...
    styles = {
        ...
        "assistant": {
            ...
            "panel_title": "AllTheBacteria AI Agent",
            "border_style": "green"
            },
        "tool_use": {
